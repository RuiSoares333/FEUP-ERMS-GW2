...
\author{\IEEEauthorblockN{1\textsuperscript{st} Rui Soares}
\IEEEauthorblockA{\textit{Faculty of Engineering} \\
\textit{University of Porto}\\
Porto, Portugal \\
email address or ORCID}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Simão Antunes}
\IEEEauthorblockA{\textit{Faculty of Engineering} \\
\textit{University of Porto}\\
Porto, Portugal \\
up202403111@up.pt}
\and
\IEEEauthorblockN{3\textsuperscript{rd} Nuno Fernandes}
\IEEEauthorblockA{\textit{Faculty of Engineering} \\
\textit{University of Porto}\\
Porto, Portugal \\
email address or ORCID}
\and
\IEEEauthorblockN{4\textsuperscript{th} Kevyn Marins}
\IEEEauthorblockA{\textit{Faculty of Engineering} \\
\textit{University of Porto}\\
Porto, Portugal \\
email address or ORCID}
...
Requirements management is essential for successful project development as it guarantees that the goals and needs of stakeholders are accurately identified, recorded, and monitored throughout the project's duration. Misinterpretations, scope expansion, and unmet objectives can all greatly affect a project's effectiveness, but these issues can be reduced through efficient requirements management.

By providing a centralized platform for structuring and decomposing requirements into actionable specifications, Helix RM supports this process. HelixRM promotes stakeholder collaboration and ensures that requirements align with business objectives through features such as version control, traceability, hierarchical organization, and integration with Jira. Its capabilities make it an essential tool for managing complex or large-scale projects, allowing teams to maintain consistency, quickly adapt to changes, and improve project transparency.

\section{Functionalities of HelixRM}

\subsection{Track Requirements}
\subsection{Review Requirements}
\subsection{Decompose Requirements}
...
\bibitem{b1} GetApp, "Helix RM Pricing, Features, Reviews and Alternatives." Available: \url{https://www.getapp.com}. Accessed: Nov. 2024.

\bibitem{b2} A2IS, "Helix RM Requirements Management Features." Available: \url{https://a2is.com/catalog/requirements-management-software/helix-rm}. Accessed: Nov. 2024.
